...
return [
    ...
    */
    ...
    |--------------------------------------------------------------------------
    |
    | These settings are owned by the service application rather than the
    | vendor package. Internal services should resolve provider, model,
    | timeout, and retry behavior from here through the app abstraction.
    |
    */
