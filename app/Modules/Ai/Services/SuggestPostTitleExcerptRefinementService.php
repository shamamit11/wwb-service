...
use App\AI\Agents\TitleExcerptRefinementAgent;
...
class SuggestPostTitleExcerptRefinementService
{
    public function __construct(
        private readonly TitleExcerptRefinementAgent $agent,
    ...
    public function handle(
        ...
        if (! $result->isSuccessful()) {
            throw new RuntimeException($result->error?->message ?? 'Title/excerpt refinement agent failed.');
        }
