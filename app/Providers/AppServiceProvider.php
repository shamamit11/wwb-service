...
use App\Modules\ArticleVideos\Repositories\EloquentArticleVideoMemoryEntryRepository;
use App\Modules\ArticleVideos\Repositories\EloquentArticleVideoRecommendationRepository;
use App\Modules\ArticleVideos\Repositories\EloquentArticleVideoRepository;
...
class AppServiceProvider extends ServiceProvider
{
    ...
    public function register(): void
    {
        ...
        $this->app->bind(ArticleVideoRecommendationRepository::class, EloquentArticleVideoRecommendationRepository::class);
        $this->app->bind(ArticleVideoRepository::class, EloquentArticleVideoRepository::class);
        $this->app->bind(ArticleVideoMemoryEntryRepository::class, EloquentArticleVideoMemoryEntryRepository::class);
