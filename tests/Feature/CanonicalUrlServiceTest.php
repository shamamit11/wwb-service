...
class CanonicalUrlServiceTest extends TestCase
{
    ...
    public function test_service_derives_default_canonical_urls_by_content_type(): void
    {
        ...
        $this->assertSame('https://widewebblog.test/categories/ai-agents/', $service->for($category));
        $this->assertSame('https://widewebblog.test/how-ai-agent-memory-works/', $service->for($post));
    }
    ...
    public function test_published_post_resource_exposes_canonical_value(): void
    {
        ...
        $this->assertSame('https://widewebblog.test/how-ai-agent-memory-works/', $payload['canonical_url']);
    }
