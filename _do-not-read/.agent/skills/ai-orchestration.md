...
Use this skill for provider abstraction, prompt orchestration, AI jobs, generation-step tracking, topic discovery, scored-topic automation, draft generation, and token or cost tracking.
...
- building topic discovery or draft workflows
...
- generated content remains draft until admin approval
...
- separate provider client, prompt renderer, and orchestration service
...
- ensure score-based automation never bypasses draft-first publish rules
